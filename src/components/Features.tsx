  ...
  const features = [
    {
      ...
      darkColor: 'dark:bg-yellow-900/40 dark:text-yellow-200'
    },
    {
      ...
      darkColor: 'dark:bg-blue-900/40 dark:text-blue-200'
    },
    {
      ...
      darkColor: 'dark:bg-green-900/40 dark:text-green-200'
    },
    {
      ...
      darkColor: 'dark:bg-purple-900/40 dark:text-purple-200'
    },
    {
      ...
      darkColor: 'dark:bg-indigo-900/40 dark:text-indigo-200'
    },
    {
      ...
      darkColor: 'dark:bg-cyan-900/40 dark:text-cyan-200'
    }
  ]
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="feature-card">
              <div className={`inline-flex items-center justify-center w-12 h-12 rounded-lg ${feature.color} ${feature.darkColor} mb-4`}>
